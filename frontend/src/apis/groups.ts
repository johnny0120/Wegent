...
export const groupsApi = {
  ...
  // Note: Group resource CRUD endpoints have been removed.
  // Use unified endpoints with scope parameter instead:
  // - Models: Use modelApis.getUnifiedModels with scope parameter
  // - Bots: Use botApis methods with scope parameter
  // - Teams: Use teamApis methods with scope parameter
  // - Shells: Use shellApis methods with scope parameter
  //
  // Example: modelApis.getUnifiedModels(shellType, includeConfig, `group:${groupName}`)
}
